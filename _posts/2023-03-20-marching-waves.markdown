...
When I started working with the Roland, I would've been appalled at the idea of writing this article — I had long been afraid of other people stealing my source code and replicating my pieces. Seven months of work later, I was no longer worried. The additional knowledge required to get the results I want on paper exists nowhere but in my head, and I acquired it by going far past the point where any sane person would've given up. 

With no existing reference available, I had to push through bewildering, very specific problems with ink flow, smearing, paper movement, acceleration curves, anti-aliasing... the list goes on. As long as I keep my mouth shut, the only way to find the solutions to them is through months of trial-and-error. Those are the secrets I will keep for now.
